...
/**
 * Contains the deck for Chance and Community Chest cards
 */
public class Deck {
    ...
    /**
     * Draws a chance card from the top of the Deck
     * @param player the player which drew the card
     * @return the card drawn
     */
    public EventCard drawChanceCard(AbstractPlayer player) {
        ...
        if (c != null) {
            return c.useCard(playerList, player);
        }
     ...
     * @return the card drawn
     */
    public EventCard drawCommunityChestCard(AbstractPlayer player) {
